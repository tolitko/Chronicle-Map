...
you should configure the key size in serialized form. If your key size varies, you should
provide the *average* number of bytes of keys' serialized form, using method `averageKeySize()`:
